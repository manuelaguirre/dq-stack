...
for question, answers in question_dict.items():
  ...
  while run:
    ...
    for event in pygame.event.get():
      ...
      screen.blit(resizedImage, ((myScreenWidth // 2) - (resizedImage.get_width() // 2), (myScreenLength // 2) - (resizedImage.get_height() // 3)+100)) 
      ...
      if reponse!=myListOfAnswers[0]:
        ...
        mybut=pygame.image.load("icones/GREEN_button_150T.png").convert_alpha()
...
pygame.display.flip()
clock.tick(30)
mysentence = "Partie terminee apres {} (mn:ss) !! Votre score est de: {:d} de {:d}".format(get_chrono(ts_debut_chrono),score,TotalOfQuestions)
